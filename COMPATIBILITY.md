...
| `v0.3.0-rc.0` branch candidate | exact `t4-portability` commit | v0.2 records plus Runtime API, Memory Port, and Runtime client candidate behavior | 20, 22, 24 | Unreleased; cross-repository candidate conformance |
