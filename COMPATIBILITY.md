...
| `v0.3.0-rc.0` branch candidate | exact `v0.2.1` | v0.2 records plus Memory Port and Runtime client candidate behavior | 20, 22, 24 | Unreleased; requires two independent durable adapters and clients |
