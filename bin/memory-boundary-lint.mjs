...
const help = `house-memory-boundary-lint <file-or-directory> [...] [--profile 0.1|0.2] [--json|--sarif]

Validates Memory Policy Decisions and rejects unsupported promotion or high-risk actions.`;
...
try {
  ...
  if (options.help) console.log(help);
    ...
    const report = lintProtocol("memory_policy_decision", options.inputs, { profile: options.profile });
  ...
  console.error(`house-memory-boundary-lint: ${error.message}`);
  process.exitCode = 2;
}
